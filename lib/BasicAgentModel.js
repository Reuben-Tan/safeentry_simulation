...
var currentTime = 0;
var statistics = [
{"name":"Average time in clinic, Type A: ","location":{"row":4,"col":4},"cumulativeValue":0,"count":0},
{"name":"Average time in clinic, Type B: ","location":{"row":4,"col":4},"cumulativeValue":0,"count":0}
];
...
if (Math.random()< probArrival){
	var newpatient = {"id":1,"type":"A","location":{"row":1,"col":5},
